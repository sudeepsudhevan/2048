        ...
        for (var j = i; j >= i - 2; j--) {
            if (arr[j].innerHTML !== "") {
                ...
                while (k < i + 1 && (parseInt(arr[k + 1].innerHTML) === parseInt(arr[k].innerHTML) || arr[k + 1].innerHTML === "")) {
                    if (parseInt(arr[k + 1].innerHTML) === parseInt(arr[k].innerHTML) && !access) {
        ...
        for (var j = i; j >= 0; j = j - 4) {
            if (arr[j].innerHTML !== "") {
                ...
                while (k < 12 && (parseInt(arr[k + 4].innerHTML) === parseInt(arr[k].innerHTML) || arr[k + 4].innerHTML === "")) {
                    if (parseInt(arr[k + 4].innerHTML) === parseInt(arr[k].innerHTML) && !access) {
...
function end() {
    alert("Your Score Is:" + score.innerHTML + " Game Over");
    reset();
}
